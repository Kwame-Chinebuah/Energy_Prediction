...
avg_rainfall = st.number_input("Average Rainfall (mm)", min_value=0.0, max_value=3000.0, value=800.0)
avg_mean_temp = st.number_input("Average Mean Temperature (°C)", min_value=-5.0, max_value=30.0, value=10.0)
total_meters = st.number_input("Total Meters (K)", min_value=10.0, max_value=500.0, value=100.0)
